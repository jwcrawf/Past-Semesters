...
// *********************************
// set key and data types
// *********************************

// This is the Key = String, Data = int case
#include <xran.h>
#include <xranxstr.h>
...
// *********************************
// choose OAA implementation details
// *********************************

// BST implementation
#include <oaa_bst.h>
typedef fsu::OAA<KeyType,DataType> OAA;
// */

/* // RBLLT implementation
#include <oaa_rbllt.h>
typedef fsu::OAA<KeyType,DataType> OAA;
// */
...
const      unsigned int putPercent     =       50;    // growth
const      unsigned int assignPercent  =       30;    // rate
const      unsigned int erasePercent   =       30;    // and
const      unsigned int rehashPercent  =       30;    // volatility
// */
